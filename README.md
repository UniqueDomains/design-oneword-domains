...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C281%20rows-8250df">
...
**Public extract:** 7,281 rows · **Live catalog:** 7,273 domains
...
- `design.csv` — public CSV extract (7,281 rows)
- `design.json` — public JSON extract (7,281 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,281-row public sample | 7,273 live domains                               |
