...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C277%20rows-8250df">
...
**Public extract:** 7,277 rows · **Live catalog:** 7,273 domains
...
- `design.csv` — public CSV extract (7,277 rows)
- `design.json` — public JSON extract (7,277 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,277-row public sample | 7,273 live domains                               |
...
> Unique Domains. *Available .DESIGN One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
